...
plugin_identifier = "adv_eeprom_marlin"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_adv_eeprom_marlin"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Adv_EEprom-Marlin"

# The plugin's version. Can be overwritten within OctoPrint's internal data via __plugin_version__ in the plugin module
plugin_version = "2.S3DP"
...
plugin_author = "Ketchu13"

# The plugin's author's mail address.
plugin_author_email = "ketchu13@hotmail.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/ketchu13/OctoPrint-Adv_EEprom-Marlin"
